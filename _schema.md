...
| 3 | `~/.claude/wiki/**` | Source of truth | Full content. Synthesized, cross-referenced. |
...
- (v) Contradictions, orphan pages, concept gaps. Written to `~/.claude/wiki/_dream-report-YYYY-MM-DD.md` for triage.
